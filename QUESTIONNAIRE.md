...
4. Connaissez-vous les différentes méthodes d'attaque informatique ? Si oui, lesquelles ?

   Password brute-force, SQL injection, Man in the middle, Relay Attack, Packet sniffing, Netbios IPC, etc
   
6. Avez-vous déjà entendu parler des tests d'intrusion ? (Oui/Non)
   
   Oui
   
8. Pouvez-vous expliquer ce qu'est un SIEM (Security Information and Event Management) ?
   
   
   Non
   
10. Quels sont les principaux types de malwares ?
